...
'
SetupOptions = "/S /acceptlicense /start-menu /runnow /server='https://innerbit.dyndns.info/glpi/plugins/fusioninventory/' /add-firewall-exception /installtasks=Full /execmode=Service /httpd-trust='127.0.0.1' /tag=%empresa%"
' Setup
